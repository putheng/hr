...
<div class="card">
	<div class="card-body">
		...
		<app-form action="/api/salary/create" method="post" class="col-md-6" commit="admin/setSalary">
			...
			<tbody>
				<tr v-for="(item, key) in salaries">
					...
					<td>
						...
						<app-modal 
							commit="admin/setSalary"
							:key="key" :data="{id:item.id}"
							:option="{ title: 'Update', url: '/api/salary/edit'}"
						...
						<app-modal 
							...
							:option="{ title: 'Delete', url: '/api/salary/delete'}"
